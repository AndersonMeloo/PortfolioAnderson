...
export default function ScrollToTop() {
  ...
  return (
    <button
      onClick={scrollToTop}
      className={`fixed bottom-10 right-10 z-[9999] flex h-14 w-14 items-center justify-center rounded-full bg-black/80 backdrop-blur-xl border border-white/20 transition-all duration-500 hover:scale-110 active:scale-95 ${
        isVisible 
